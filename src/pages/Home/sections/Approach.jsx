        ...
        <div className={s.grid}>
          <div className={s.intro}>
            ...
            <h2 id="approach-title" className={s.title}>
              A space to be heard.<br />A plan that&rsquo;s yours.
            </h2>
          </div>
          ...
          <div className={s.body}>
            ...
            <div className={s.actions}>
              <Button to="/about" variant="outline">More about me</Button>
              <Button to="/services" variant="ghost">View services &amp; modalities</Button>
            </div>
          </div>
        </div>
      </div>
